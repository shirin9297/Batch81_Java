...
public class C01_AsciiTable {
    public static void main(String[] args) {
        // 6- Bir tamsayi, bir de char olusturun ve bunlarin toplamini yazdirin
        ...
        eger matematiksel isleme girdigi variable sayisal bir degerse sayi gibi davranir
          ...
          char yeniHarf = harf+2; java once islemi yapar, sagda int+char gorunce ascii degerini alir ve sonucu 99
